...
void surf (Input IN, inout SurfaceOutput o) {
	...
	float4 gls = lerp(float4(0.5,0.5,0.5,0.5), float4(0.25,0.25,0.25,0.25), tex2D(_Gloss, IN.uv_MainTex));
	float4 spec = pow(tex2D(_Specular,IN.uv_MainTex), float4(1.0/0.7,1.0/0.7,1.0/0.7,1.0/0.7));
